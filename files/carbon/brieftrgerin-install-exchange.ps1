...
# Mount Exchange Server 2019 Installation Mediaclick here to download manually
# Exchange Server 2019 Installation Media must be downloaded separately from Microsoft

$ExchangeISO = "C:\Windows\Temp\EXCHANGE2019.ISO"
If (Test-Path -path $ExchangeISO -PathType Leaf) {
